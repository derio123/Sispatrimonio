                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-sm-9 col-md-9">
                            <div class="form-group form-check-label">
                                ...
                                <input type="radio"
                                    onclick="document.getElementById('Moveis').style.display = 'none', document.getElementById('Info').style.display = 'initial',
                                 document.getElementById('Moveis').style.display = 'none'"
                                    value="Informatica" name="categoria">Informatica</input>
                            </div>
                            <div class="col-sm-9 col-md-9 text-left" id="Info">
                                <div class="form-check-label">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            ...
                                            <input class="form-control" type="text" name="cod_gabinete"
                                                placeholder="N° patrimônio" id="" value="{{ old('cod_gabinete') }}"
                                                autofocus>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-check-label">
                                        ...
                                        <input type="radio" name="Qtd_Monitor"
                                            onclick="document.getElementById('qtd2').style.display = 'none',
                                         document.getElementById('qtd1').style.display = 'initial'"
                                            value="1">1</input>
                                        <input type="radio" name="Qtd_Monitor"
                                            onclick="document.getElementById('qtd1').style.display = 'initial',
                                         document.getElementById('qtd2').style.display = 'initial'"
                                            value="2">2</input>
                                    </div>
                                    <div class="form-check-label">
                                        <div class="input-group mb-3">
                                        ...
                                        <div class="input-group-prepend col-7 mb-2 row py-0" id="">
                                            ...
                                            <textarea name="descricaoInfo" class="form-control" placeholder="descreva inventário de informatica"
                            ...
                            <div class="form-group form-check-label">
                                <label for="description">Categoria</label>
                                <input type="radio"
                                    onclick="document.getElementById('Moveis').style.display = 'initial', document.getElementById('Info').style.display = 'initial',
                                    document.getElementById('Info').style.display = 'initial'"
                                    name="categoria" value="Moveis">Móveis</input>
                            </div>
                            <div class="col-sm-9 col-md-9 text-left form-check-label" id="Moveis">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        ...
                                        <input class="form-control" size="30" placeholder="Insira o N° patrimônio"
                                            type="text" name="cod_Mesa" id="tab" value="{{ old('cod_Mesa') }}"
                                            autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="input-group form-check-label mt-3 mb-3">
                                    <div class="input-group-prepend">
                                        ...
                                        <input class="form-control mb-2" size="30"
                                            placeholder="Insira o N° patrimônio" type="text" name="cod_Cadeira"
                                            value="{{ old('cod_Cadeira') }}" id="gav" autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="form-check-label input-group mb-2">
                                    <div class="input-group-prepend">
                                        ...
                                        <input class="form-control mb-2" placeholder="Insira o N° patrimônio"
                                            type="text" name="cod_Outro" id="cad"
                                            value="{{ old('cod_Outro') }}" autofocus>
                                    </div>
                                </div>
                                ...
                                <div class="input-group mb-2">
                                    <div class="input-group-prepend col-7 mt-3 mb-1 row py-0" id="">
                                        <p class="m-1" for="">Descrição</p>
                                        <textarea name="descricaoMoveis" class="form-control" placeholder="descreva inventário de móveis"
                                            id="exampleFormControlTextarea1" rows="3" autofocus>{{ old('descricaoMoveis') }}</textarea>
                                    </div>
                                </div>
                                <div class="input-group">
                                    <div class="input-group-prepend mt-2 col-6 mb-1">
                                        <p class="m-1" for="">Sala/Equipe</p>
                                        <select name="sala" class="form-control" name="sala" id=""
                                            autofocus>
                            ...
                            <button type="submit" class="btn btn-primary text-white lead mb-3"><i
                                    class="fas fa-save"></i>
                                Salvar</button>
