            ...
            <div class="row justify-content-md-center">
                <div class="col-sm-9 col-md-9">
                    ...
                    <div class="form-group form-check-label">
                        ...
                        <input type="radio"
                        onclick="document.getElementById('Moveis').style.display = 'none',
                    ...
                    <div class="col-sm-9 col-md-12 text-left">
                        <div class="form-check-label" id="Info">
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control col-5" type="text" value="{{$patrimonios->computador}}" name="computador" placeholder="N° patrimônio" id="" autofocus>
                            </div>
                    ...
                    <div class="col-sm-9 col-md-12 text-left">
                        <div class="form-check-label input-group" id="Moveis">
                            ...
                            <div class="input-group-prepend">
                                ...
                                <input class="form-control mb-2" placeholder="Insira o código do patrimonio" type="text" name="mesa" value="{{$patrimonios->mesa}}" id="tab" autofocus>
                            </div>

                            <div class="input-group-prepend">
                                <p class="m-1" for="gav" for="name">Cadeira</p>
                                <input class="form-control mb-2" placeholder="Insira o código do patrimonio" type="text" name="gaveteiro" value="{{$patrimonios->gaveteiro}}" id="gav" autofocus>
                            </div>

                            <div class="input-group-prepend">
                                <p class="m-1" for="cad" for="description">Gavateiro</p>
                                <input class="form-control mb-2" placeholder="Insira o código do patrimonio" type="text" name="cadeira" value="{{$patrimonios->cadeira}}" id="cad" autofocus>
                            </div>
